...
PokemonSpeciesDetails pokemonSpeciesDetailsFromJson(String str) =>
    PokemonSpeciesDetails.fromJson(json.decode(str));

String pokemonSpeciesDetailsToJson(PokemonSpeciesDetails data) =>
