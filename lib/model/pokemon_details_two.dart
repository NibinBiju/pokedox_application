...
//
//     final pokemonSpeciesDetails2 = pokemonSpeciesDetails2FromJson(jsonString);

import 'dart:convert';

PokemonSpeciesDetailsTwo pokemonSpeciesDetails2FromJson(String str) => PokemonSpeciesDetailsTwo.fromJson(json.decode(str));

String pokemonSpeciesDetails2ToJson(PokemonSpeciesDetailsTwo data) => json.encode(data.toJson());

class PokemonSpeciesDetailsTwo {
    ...
    factory PokemonSpeciesDetailsTwo.fromJson(Map<String, dynamic> json) => PokemonSpeciesDetailsTwo(
